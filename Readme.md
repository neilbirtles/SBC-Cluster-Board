...
The slots for SBC have been spaced so that a single 120mm fan can cool them all removing the noise of 5 smaller fans. The SBC² provides a 12V step-up converter to power the fans from the proper voltage to ensure efficent cooling without the need for a second power supply.
